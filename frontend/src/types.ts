export interface Review { id: string; location_id: string; reviewer_name: string; rating: number; body: string; review_date: string; platform: string; sentiment: 'positive' | 'neutral' | 'negative'; responded_at: string | null }
